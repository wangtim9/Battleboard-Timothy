...
public class Battleship {
	public String Start() {
		...
		System.out.println("Hunt, sink, and win with this brilliant Battleship game! Can you sink your opponents ships before all of yours go down? Command your battle and deploy your 5 ships on the ocean grid. The vertical target grid keeps you from seeing each others deployment! Keep firing and record your strikes with the red pegs. Use the white pegs to keep track of your misses so you dont waste any shots. If you use logic and take some chances, youll sink your opponents battleship  but do it fast, because theyll be trying to do the same to you! Rule the oceans with your Battleship game!

Classic Battleship game includes 10 plastic ships, 60 red pegs and 140 white pegs
...
For 2 players.");
		System.out.println("You got that? Type Y to play");
